...
function LeftSidebarWalkthrough() {
  ...
  return (
    <div className="fixed inset-0  z-50 bg-black bg-opacity-40">
      <div className="absolute left-20 top-40 bg-[#191A1F] py-10 px-14 rounded-lg w-1/2 flex flex-col items-center gap-8 ">
        ...
        <p className=" text-white font-medium text-lg  ">
          ...
          Hobbies, you can swiftly navigate to any section with a simple click.
          You're the architect of your resume.. 😉
        </p>
