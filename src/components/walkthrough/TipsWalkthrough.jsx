...
function TipsWalkthrough() {
  ...
  console.log(array);
  return (
    <div className="fixed inset-0 flex  z-50 bg-black bg-opacity-40">
      <div className="absolute right-20 top-40 bg-[#191A1F] py-10 px-14 rounded-lg w-1/2 flex flex-col items-center gap-8 ">
        ...
        <p className=" text-white font-medium text-lg  ">
          Seeking expert advice? Click on{" "}
          <span className="text-primary-500">'Tips & Suggestions'</span>.
          Receive tailored, AI-powered recommendations to enhance your resume.
          With Konectin, you have a knowledgeable ally on your job search
          journey. 😉
        </p>
...
export default TipsWalkthrough;
