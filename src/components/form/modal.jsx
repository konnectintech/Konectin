...
export function NotifyModal({
  ...
  return (
    <div className="relative w-10/12 max-w-screen-md py-8 transition ease-in-out duration-300 flex flex-col md:flex-row px-6 md:px-16 gap-6 md:gap-12 items-center text-white md:min-h-[70vh] max-md:max-h-[600px]">
      <div
