...
const Faq = () => {
    ...
    const answerArray = Array.from(document.getElementsByClassName('answer'));
    ...
    <div className='flex flex-col gap-4 p-16'>
        {
            FAQ.length > 0 && FAQ.map((value, index) => {
                return(
                    <div className='p-2 border border-2 border-black rounded-lg text-sm w-fit' key={index}>
                        <div className='flex items-center gap-2' onClick={
                            () => {
                                ...
                                answerArray[index].classList.contains('flex') ? symbolArray[index].innerHTML = '-' :
