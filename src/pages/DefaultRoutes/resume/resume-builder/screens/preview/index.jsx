    ...
    <div className="mt-8 max-w-6xl flex mx-auto flex-col">
      ...
      <div className="w-full flex flex-col items-center md:flex-row gap-10 mt-6">
        ...
        <div className="md:w-1/2 px-4 md:px-0">
          <p className="max-w-[45ch] font-bold text-neutral-300 text-sm lg:text-center tracking-[-0.01rem] mt-3 mb-5">
          ...
          <div className="max-w-xl w-full flex flex-col justify-center mt-8 lg:mt-16 md:mt-8 gap-5 md:flex-row mx-auto">
            <button
              onClick={() => navigate(-1)}
              className="w-full max-w-xs border border-neutral-500 rounded-lg text-sm py-3 px-3"
            >
              Back
            </button>
            <button
              ...
              type="submit"
              className="w-full max-w-xs rounded-lg text-sm text-neutral-900 bg-primary-500 px-3 py-3"
            >
              Continue
            </button>
          </div>
