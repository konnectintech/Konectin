...
const TermsAndCondition = () => {
  return (
    <div className="pt-20 pb-8 bg-neutral-500 grid grid-cols-1 md:grid-cols-[250px,4fr] grid-rows-[6%,1fr] ">
      {/* Sidebar section */}
      <section className="py-8 lg:py-16 lg:px-8 px-16 text-2xl bg-neutral-1000 md:max-h-[10%] md:row-span-full sticky min-h-[40vh] ">
        <h5 className="  font-bold mb-3 ">Table Of Contents</h5>
        <div className="flex flex-col">
          <Link
            className=" hover:text-primary-800 hover:cursor-pointer my-2 ml-0 md:ml-8   text-primary-500 font-medium font-[Avenir] truncate"
            to="Accounts"
            spy={true}
            smooth={true}
            offset={-100}
      ...
      {/* Header Section */}
      <div className=" row-start-1 py-8 px-12 mb-4">
        <h1 className="text-center text-2xl md:text-5xl font-[Merriweather] font-bold mb-12 ">
          Terms of Service
        </h1>
        <p className="font-medium font-[Avenir] text-sm mb-10 ">
          The website located at www.konectinyou.com (the “Site”) is a
          copyrighted work belonging to Konectin Inc (“Company”, “us”, “our”,
        ...
        <p className="font-medium font-[Avenir] text-sm mb-10 ">
          ...
          WERE ASSERTED PRIOR TO THE EFFECTIVE DATE OF YOUR ACCEPTANCE OF THESE
          TERMS. IN PARTICULAR, IT CONTAINS AN ARBITRATION AGREEMENT WHICH WILL,
          WITH LIMITED EXCEPTIONS, REQUIRE DISPUTES BETWEEN US TO BE SUBMITTED
          TO BINDING AND FINAL ARBITRATION. UNLESS YOU OPT OUT OF THE
          ARBITRATION AGREEMENT: (1) YOU WILL ONLY BE PERMITTED TO PURSUE
          DISPUTES OR CLAIMS AND SEEK RELIEF AGAINST US ON AN INDIVIDUAL BASIS,
      ...
      <div className="px-12 ">
        {/* Accounts" */}
        <div className="mt-6 mb-16" id="Accounts">
          <>
            <section className="font-[Avenir] ">
              <div className="p-2 bg-primary-300 w-full mb-4">
                <h1 className=" text-2xl font-medium ">1. Accounts</h1>
              </div>

              <div className="mb-8">
                <h2 className="capitalize text-lg">1.1 Account Creation</h2>
        ...
        {/* AccesstoSite */}
        <div className="mt-6 mb-16" id="AccessToSite">
          <>
            <section className="font-[Avenir] ">
              <div className="p-2 bg-primary-300 w-full mb-4">
              ...
              <div className="mb-8">
                <h2 className="capitalize text-lg mb-2">2.1 License </h2>
                <p className=" text-base">
              ...
              <div className="mb-8">
                <h2 className="capitalize text-lg mb-2">
                ...
                <p className=" text-base">
                  ...
                  website, product, or service; and (d) except as expressly
              ...
              <div className="mb-8">
                <h2 className="capitalize text-lg mb-2">2.3 Modification</h2>
                <p className=" text-base">
              ...
              <div className="mb-8">
                <h2 className="capitalize text-lg mb-2">2.5 Ownership </h2>
                <p className=" text-base">
              ...
              <div className="mb-8">
                <h2 className="capitalize text-lg mb-2">2.6 Feedback</h2>
                <p className=" text-base">
        ...
        {/* UserContent */}
        <div className="mt-6 mb-16" id="UserContent">
          <>
            <section className="font-[Avenir] ">
              <div className="p-2 bg-primary-300 w-full mb-4">
                <h1 className=" text-2xl font-medium ">3. User Content</h1>
              </div>

              <div className="mb-8">
                <h2 className="capitalize text-lg mb-2">3.1 User Content </h2>
                <p className=" text-base">
                  “User Content” means any and all information and content that
                  a user submits to, or uses with, the Site (e.g., content in
                  the user’s profile or postings). You are solely responsible
                  for your User Content. You assume all risks associated with
                  use of your User Content, including any reliance on its
                  ...
                  (defined in Section 3.3). You may not represent or imply to
              ...
              <div className="mb-8">
                <h2 className="capitalize text-lg mb-2">3.2 License </h2>
                <p className=" text-base">
              ...
              <div className="mb-8">
                ...
                <p className=" text-base">
                  ...
                  restrictions imposed by any third party. (b) In addition, you
                  agree not to: (i) upload, transmit, or distribute to or
                  through the Site any computer viruses, worms, or any software
                  intended to damage or alter a computer system or data; (ii)
                  ...
                  to harvest, collect, gather or assemble information or data
              ...
              <div className="mb-8">
                <h2 className="capitalize text-lg mb-2">3.4 Enforcement</h2>
                <p className=" text-base">
                  We reserve the right (but have no obligation) to review,
                  refuse and/or remove any User Content in our sole discretion,
                  and to investigate and/or take appropriate action against you
                  in our sole discretion if you violate the Acceptable Use
        ...
        {/* Indemnification */}
        <div className="mt-6 mb-16" id="Indemnification">
          <>
            <section className="font-[Avenir] ">
              <div className="p-2 bg-primary-300 w-full mb-4">
                <h1 className=" text-2xl font-medium ">4. Indemnification</h1>
              </div>
        ...
        {/* Third-Party */}
        <div className="mt-6 mb-16" id="ThirdParty">
          <>
            <section className="font-[Avenir] ">
              <div className="p-2 bg-primary-300 w-full mb-4">
                <h1 className=" text-2xl font-medium ">
              ...
              <div className="mb-8">
                <h2 className="capitalize text-lg mb-2">5.2 Other Users</h2>
                <p className=" text-base">
              ...
              <div className="mb-8">
                <h2 className="capitalize text-lg mb-2">5.3 Release</h2>
                <p className=" text-base">
        ...
        {/* Disclaimer */}
        <div className="mt-6 mb-16" id="Disclaimers">
          <>
            <section className="font-[Avenir] ">
              <div className="p-2 bg-primary-300 w-full mb-4">
                <h1 className=" text-2xl font-medium ">6. Disclaimers</h1>
              </div>
              ...
              <div className="mb-8">
                <p className=" text-base">
                  ...
                  NINETY (90) DAYS FROM THE DATE OF FIRST USE. SOME
        ...
        {/* LimitOnLiability */}
        <div className="mt-6 mb-16" id="LimitOnLiability">
          <>
            <section className="font-[Avenir] ">
              <div className="p-2 bg-primary-300 w-full mb-4">
                <h1 className=" text-2xl font-medium ">
              ...
              <div className="mb-8">
                <p className=" text-base">
                  ...
                  OR LOSS OF DATA RESULTING THEREFROM. TO THE MAXIMUM EXTENT
                  PERMITTED BY LAW, NOTWITHSTANDING ANYTHING TO THE CONTRARY
                  CONTAINED HEREIN, OUR LIABILITY TO YOU FOR ANY DAMAGES ARISING
                  ...
                  KIND ARISING FROM OR RELATING TO THESE TERMS. SOME
        ...
        {/* TermAndTermination */}
        <div className="mt-6 mb-16" id="TermAndTermination">
          <>
            <section className="font-[Avenir] ">
              <div className="p-2 bg-primary-300 w-full mb-4">
                <h1 className=" text-2xl font-medium ">
              ...
              <div className="mb-8">
                <p className=" text-base">
                  ...
                  Terms will remain in effect: Sections 2.2 through 2.6, Section
        ...
        {/* Indemnification */}
        <div className="mt-6 mb-16" id="CopyRightPolicy">
          <>
            <section className="font-[Avenir] ">
              <div className="p-2 bg-primary-300 w-full mb-4">
                <h1 className=" text-2xl font-medium ">9. Copy Right Policy</h1>
              </div>
              ...
              <div className="mb-8">
                <p className=" text-base mb-6">
                  ...
                  to our designated Copyright Agent: 1. your physical or
                  electronic signature; 2. identification of the copyrighted
                  work(s) that you claim to have been infringed; 3.
                  identification of the material on our services that you claim
                  is infringing and that you request us to remove; 4. sufficient
                  information to permit us to locate such material; 5. your
                  address, telephone number, and e-mail address; 6. a statement
                  that you have a good faith belief that use of the
                  objectionable material is not authorized by the copyright
                  owner, its agent, or under the law; and 7. a statement that
                ...
                <p className=" text-base ">
                  ...
                  Address of Agent: 651 N Broad St. Suite 201, Middletown,
                  Delaware 19709
                </p>
              </div>
            </section>
        ...
        {/* General */}
        <div className="mt-6 mb-16" id="General">
          <>
            <section className="font-[Avenir] ">
              <div className="p-2 bg-primary-300 w-full mb-4">
                <h1 className=" text-2xl font-medium ">10. General</h1>
              </div>

              <div className="mb-8">
                <h2 className="capitalize text-lg mb-2">10.1 Changes </h2>
                <p className=" text-base">
              ...
              <div className="mb-8">
                ...
                <p className=" text-base">
                  ...
                  ACTION WAIVER. (a) Applicability of Arbitration Agreement. All
                  claims and disputes (excluding claims for injunctive or other
                  equitable relief as set forth below) in connection with these
                  ...
                  provided under these Terms. (b) Notice Requirement and
                  Informal Dispute Resolution. Before either party may seek
                  arbitration, the party must first send to the other party a
                  written Notice of Dispute (“Notice”) describing the nature and
                  basis of the claim or dispute, and the requested relief. A
                  Notice to the Company should be sent to: 651 N Broad St. Suite
                  201, Middletown, Delaware 19709. After the Notice is received,
                  ...
                  determined the amount of the award, if any, to which either
                  party is entitled. (c) Arbitration Rules. The Federal
                  Arbitration Act governs the interpretation and enforcement of
                  this Arbitration Agreement. The arbitration will be conducted
                  by JAMS, an established alternative dispute resolution
                  provider. Disputes involving claims, counterclaims, or request
                  for relief under $250,000, not inclusive of attorneys’ fees
                  and interest, shall be subject to JAMS’s most current version
                  of the Streamlined Arbitration Rules and procedures available
                  ...
                  of the ADR Provider. You may choose to have the arbitration
                  conducted by telephone, based on written submissions, or in
                  person in the country where you live or at another mutually
                  agreed location. Any judgment on the award rendered by the
                  arbitrator may be entered in any court of competent
                  jurisdiction. (d) Authority of Arbitrator. The arbitrator
                  ...
                  binding upon you and us. (e) Waiver of Jury Trial. YOU AND
                  COMPANY HEREBY WAIVE ANY CONSTITUTIONAL AND STATUTORY RIGHTS
                  ...
                  is subject to very limited review. (f) Waiver of Class or
                  Other Non-Individualized Relief. ALL DISPUTES, CLAIMS, AND
                  REQUESTS FOR RELIEF WITHIN THE SCOPE OF THIS ARBITRATION
                  AGREEMENT MUST BE ARBITRATED ON AN INDIVIDUAL BASIS AND NOT ON
                  A CLASS OR COLLECTIVE BASIS, ONLY INDIVIDUAL RELIEF IS
                  AVAILABLE, AND CLAIMS OF MORE THAN ONE CUSTOMER OR USER CANNOT
                  BE ARBITRATED OR CONSOLIDATED WITH THOSE OF ANY OTHER CUSTOMER
                  OR USER. If a decision is issued stating that applicable law
                  precludes enforcement of any of this section’s limitations as
                  to a given dispute, claim, or request for relief, then such
                  aspect must be severed from the arbitration and brought into
                  the State or Federal Courts located in the State of Delaware.
                  All other disputes, claims, or requests for relief shall be
                  arbitrated. (g) 30-Day Right to Opt Out. You have the right to
                  opt out of the provisions of this Arbitration Agreement by
                  sending written notice of your decision to opt out to:
                  admin@konectinyou.onmicrosoft.com within thirty (30) days
                  after first becoming subject to this Arbitration Agreement.
                  Your notice must include your name and address, your Company
                  username (if any), the email address you used to set up your
                  Company account (if you have one), and an unequivocal
                  statement that you want to opt out of this Arbitration
                  Agreement. If you opt out of this Arbitration Agreement, all
                  other parts of these Terms will continue to apply to you.
                  Opting out of this Arbitration Agreement has no effect on any
                  other arbitration agreements that you may currently have, or
                  may enter in the future, with us. (h) Severability. Except as
                  provided in Section 10.2(f) (Waiver of Class or Other
                  ...
                  (i) Survival of Agreement. This Arbitration Agreement will
                  survive the termination of your relationship with Company. (j)
                  Modification. Notwithstanding any provision in these Terms to
                  the contrary, we agree that if Company makes any future
                  material change to this Arbitration Agreement, you may reject
                  that change within thirty (30) days of such change becoming
                  effective by writing Company at the following address:
                  fadehanmichael006@gmail.com.
                </p>
              </div>

              <div className="mb-8">
                <h2 className="capitalize text-lg mb-2">10.3 Export</h2>
                <p className=" text-base">
              ...
              <div className="mb-8">
                <h2 className="capitalize text-lg mb-2">10.4 Disclosures</h2>
                <p className=" text-base">
              ...
              <div className="mb-8">
                <h2 className="capitalize text-lg mb-2">10.6 Entire Terms</h2>
                <p className=" text-base">
              ...
              <div className="mb-8">
                ...
                <p className=" text-base">
                  Copyright ©2023 Konectin Inc. All rights reserved. All
                  trademarks, logos and service marks displayed on the Site are
                  our property or the property of other third parties. You are
              ...
              <div className="mb-8">
                <h2 className="capitalize text-lg mb-2">10.8 Contact Information:</h2>
                <p className=" text-base">
                Michael Fadehan<br />
                Address:<br />
                651 N Broad St. Suite 201<br />
                Middletown, Delaware 19709<br />
                Telephone: +2348148595317<br />
                Email: admin@konectinyou.onmicrosoft.com
                </p>
              </div>
            </section>
          </>
