    ...
    <>
      ...
      <div className="bg-white p-4 lg:p-10 flex flex-col lg:flex-row border border-black-100 items-center lg:items-start rounded-lg gap-20">
          ...
          <div className=" bg-primary-500 rounded-lg p-10 min-h-[400px] max-w-[550px] lg:min-w-full flex flex-row justify-center items-center flex-wrap md:flex-nowrap mx-auto gap-5">
            <div className="flex flex-col items-center w-full m-auto">
              <div className="flex flex-col items-center">
                <div
                  style={{
                    background: `conic-gradient(#FC670B 87.5deg, #fff 0deg)`,
                  }}
                  className="doughnut--progressBar rounded-full border-2  w-[100px] h-[100px] flex flex-col items-center justify-center relative "
                >
                  <span className="text-white text-sm font-bold z-10">25%</span>
                  <span className="text-white mt-2 text-xs z-10">
                    Completed
                  </span>
                </div>
              </div>
        ...
        <div className="flex flex-col gap-3">
          <div>
            <span className="text-sm font-bold font-[Avenir] capitalize">personal details</span>
          ...
          <div>
            <span className="text-sm font-bold font-[Avenir] capitalize">Work History</span>
            <div className=" my-1 relative w-[15rem] md:w-[25rem] h-[0.625rem] rounded-full bg-[#CFD9FC]">
              <div
                style={{ width: `40%`}}
                className="h-full bg-[#1042F1] rounded-full"
          ...
          <div>
            <span className="text-sm font-bold font-[Avenir] capitalize">Education</span>
            <div className=" my-1 relative  w-[15rem] md:w-[25rem] h-[0.625rem] rounded-full bg-[#CFD9FC]">
              <div
                style={{ width: `70%`}}
                className="h-full bg-[#1042F1] rounded-full "
          ...
          <div>
            <span className="text-sm font-bold font-[Avenir] capitalize">Skills</span>
            <div className=" my-1 relative w-[15rem] md:w-[25rem] h-[0.625rem] rounded-full bg-[#CFD9FC]">
              <div
                style={{ width: `85%`}}
                className="h-full bg-[#1042F1] rounded-full "
          ...
          <div>
            <span className="text-sm font-bold font-[Avenir] capitalize">Other Information</span>
            <div className=" my-1 relative w-[15rem] md:w-[25rem] h-[0.625rem] rounded-full bg-[#CFD9FC]">
              <div
                style={{ width: `0%`}}
                className="h-full bg-[#1042F1] rounded-full "
