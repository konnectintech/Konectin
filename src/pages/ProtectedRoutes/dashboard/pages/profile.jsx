    ...
    <div>
      <div className="w-full p-10 bg-primary-500 text-white grid grid-cols-2 gap-10 items-center">
        <div className="flex justify-center">
          <svg width={size} height={size}>
            ...
            <circle
              ...
              stroke={strokeCirce2}
              r={rad}
              strokeDashoffset={strokeLenoffset}
        ...
        <div className="tracking-wide">
          Stand out by completing your <br /> Profile and applying with it..
        </div>
      </div>
      ...
      <div>
        {user.map((value, index) => {
          return (
            <div
              className="user-details border-b-2 border-slate-400 py-8"
              key={index}
            >
              <div>
                <img src={value.profileBg} alt="" srcset="" />
              </div>
              <div className="-mt-10 ml-8">
                <img src={value.profilePic} alt="" srcset="" />
              </div>
              <div className="grid gap-2">
                ...
                <div className="text-sm font-bold text-slate-600">
                  Employment Status: {value.status}
                </div>
                <div className="text-sm font-bold text-slate-600">
            ...
            <div key={index} className="flex flex-col py-8">
              ...
              <div className="flex flex-col md:flex-row text-xs">
                ...
                <div className="text-primary-400 flex items-center justify-end">
                  <img
                    className="p-0 m-0 w-10 inset-0 flex items-start"
                    src={value.edit}
                    alt="edit"
                  />
                  {value.editTxt}
              ...
              <div className="flex gap-2 text-xs flex-wrap py-4">
                {value.skills.map((skill, i) => {
                  return (
                    <div
                      key={i}
                      className="border-secondary-600 border-2 p-2 items-center rounded-full flex gap-2"
                    >
                      {skill}
                      <div>
                        <img src={value.delete} alt="delete" />
                      </div>
                    </div>
                  );
                })}
