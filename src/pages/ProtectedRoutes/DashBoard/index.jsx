...
const DashBoard = () => {
  ...
  return (
    <div className="dash-container w-full flex gap-4 md:h-screen md:overflow-hidden">
      <div className="dashboard-navigation w-full flex flex-col justify-between gap-20 py-10 px-5 text-white md:w-1/3 lg:w-1/4 bg-primary-500">
        ...
        <div className="navigation-content flex flex-col gap-5">
          <Link to="/dashboard/jobs">
            <div
              className={`jobs item flex item-center [&.active]:bg-white [&.active]:text-black [&.active]:border-l-4 [&.active]:border-red-700 gap-3 p-3 pl-12 font-sm hover:bg-white hover:text-black group hover:border-l-4 hover:border-red-700 rounded-sm`}
              onClick={(e) => {
                items();
            ...
            >
              <img
                src={job}
                alt="jobs available"
                className="invert sepia saturate-0 hue-rotate-305 brightness-103 contrast-103 group-hover:filter-none"
              />
              Jobs
            </div>
          </Link>
          <Link to="/dashboard/application">
            <div
              className="application item gap-3 flex item-center [&.active]:bg-white [&.active]:text-black [&.active]:border-l-4 [&.active]:border-red-700 p-3 pl-12 font-sm hover:bg-white hover:text-black group hover:border-l-4 hover:border-red-700 rounded-sm"
              onClick={(e) => {
                items();
                e.target.classList.toggle("active");
                webIndex();
          ...
          <Link to="/dashboard/profile">
            <div
              className="profile item gap-3 flex item-center [&.active]:bg-white [&.active]:text-black [&.active]:border-l-4 [&.active]:border-red-700 p-3 pl-12 font-sm hover:bg-white hover:text-black group hover:border-l-4 hover:border-red-700 rounded-sm"
              onClick={(e) => {
                items();
                e.target.classList.toggle("active");
                webIndex();
          ...
          <Link to="/dashboard/blog">
            <div
              className="blog item gap-3 flex item-center [&.active]:bg-white [&.active]:text-black [&.active]:border-l-4 [&.active]:border-red-700 p-3 pl-12 font-sm hover:bg-white hover:text-black group hover:border-l-4 hover:border-red-700 rounded-sm"
              onClick={(e) => {
                items();
                e.target.classList.toggle("active");
                webIndex();
          ...
          <Link to="/dashboard/help">
            <div
              className="help item gap-3 flex item-center [&.active]:bg-white [&.active]:text-black [&.active]:border-l-4 [&.active]:border-red-700 p-3 pl-12 font-sm hover:bg-white hover:text-black group hover:border-l-4 hover:border-red-700 rounded-sm"
              onClick={(e) => {
                items();
                e.target.classList.toggle("active");
                webIndex();
      ...
      <div
        className="web-content w-full absolute -z-10 bg-white 
