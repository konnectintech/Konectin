...
function Main() {
  return (
    <div className="sm:bg-white rounded-lg mt-10 sm:my-0 flex flex-col gap-y-5 bg-primary-100 min-w-full">
      <div className="flex flex-col gap-6 sm:bg-primary-600 sm:text-white sm:pt-6 px-12 sm:rounded-tl-lg sm:rounded-tr-lg">
